<template>
  <div class="template-list-wrap page-logs account-list-container">
    <List :request-fn="requestV1.logsList" :query="query" page-position="data" ref="listRef">
      <template #form>
        <el-form-item class="width-adjustment width-fixed" label="运单号" label-width="100px">
          <el-input v-model="query.data.waybillNumber" placeholder="运单号" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="京东PIN" label-width="100px">
          <el-input v-model="query.data.pin" placeholder="京东PIN" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="物流服务商" label-width="100px">
          <el-select
            clearable
            v-model="query.data.serviceMerchant"
            class="m-2 list-search_item"
            placeholder="物流服务商"
          >
            <el-option
        ...
        <el-form-item class="width-adjustment width-fixed" label="打印任务ID" label-width="100px">
          <el-input v-model="query.data.taskId" placeholder="打印任务ID" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="插件版本号" label-width="100px">
          <el-input v-model="query.data.pluginVersionCode" placeholder="插件版本号" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="打印时间" label-width="100px">
          <el-date-picker
        ...
        <el-form-item
          class="width-adjustment width-fixed double-input"
          label="数据时延"
          label-width="100px"
        >
          <el-input-number
        ...
        <el-form-item class="width-adjustment width-fixed" label="标准模板类型" label-width="100px">
          <el-select
            clearable
        ...
        <el-form-item class="width-adjustment width-fixed" label="标准模板URL" label-width="100px">
          <el-input v-model="query.data.standardTemplateName" placeholder="标准模板URL" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="自定义区URL" label-width="100px">
          <el-input v-model="query.data.customizeTemplateName" placeholder="自定义区URL" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="错误码" label-width="100px">
          <el-input v-model="query.data.printStatus" placeholder="错误码" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="机器ID" label-width="100px">
          <el-input v-model="query.data.machineId" placeholder="机器ID" />
        </el-form-item>
        <el-form-item class="width-adjustment width-fixed" label="是否新版面单" label-width="100px">
          <el-select
            clearable
